%
% ** Emijk(ijk,a) **
% Returns the Euler angle rates matrix.
...
% yields the angular velocity in the global coordinates.
%
% Copyright (c) 2006 James Diebel, Stanford University
%
function E = Emijk(ijk,a)
E = [(ech3i(ijk(1))'*Rmi(ijk(2),a(2))*Rmi(ijk(3),a(3)))'...
     (ech3i(ijk(2))'*Rmi(ijk(3),a(3)))'...
     (ech3i(ijk(3)))];