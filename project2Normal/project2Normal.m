...
% 	% create 3d grid of plane (wall)
% 	% for everypoint in 3d grid
% 		% check its 2d location, see get2Dfrom3D
% 		% retrieve pixel on 2d location
% 		% apply rotation on 3d point and write retrieved pixel on that lokation
% 
% 	Xstepsize = 5;
% 	Ystepsize = 5;
% 	A = Walls(wallNr, 1:3)';
...
% 	
% 	Xrange = A:(A-B)/Xstepsize:B
% 	Yrange = A:(A-C)/Xstepsize:C
% 
% 	error('whoej');
